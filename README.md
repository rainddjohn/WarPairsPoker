...
2.1 Installation: What you need to run this program is the latest version of python 3, the latest version of pygame library, and the image files makred 'WarPairsPoker Images.zip'. The images need to be in the same folder as the program.
